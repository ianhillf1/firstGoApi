...
func TestGetCustomerDetailsReturnsCustomerCorrectly(t *testing.T) {
	mock := mockCustomerRepo{}
	mock.customerToReturn = &repository.Customer {
		FirstName: "Ian",
		Surname: "Test",
...
type mockCustomerRepo struct {
	...
	customerToReturn *repository.Customer
	errorToReturn error
}

func (mock *mockCustomerRepo)GetCustomerDetails(cif string) (*repository.Customer, error) {
	mock.requestCount++
